...
class AKGPGraphManager:
    ...
    def search_by_entities(self, entities: list) -> list:
        ...
        Retrieves cases, their verdicts, court authority, jurisdiction,
        and any OVERRULES/DISSENTS/CITES relationships.
        """
    ...
    def get_conflict_chain(self, case_name: str) -> list:
        ...
        Follows OVERRULES edges transitively to find the complete
        chain of overrulings (e.g., A overrules B which overruled C).
        """
        with self.driver.session() as session:
            query = """
